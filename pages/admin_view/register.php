            ...
            <div class="card-body p-0">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 p-0">
                            ...
                            <form class="user" action="../../controllers/UserController.php" method="post">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="text" name="name_register" class="form-control form-control-user"
                                               placeholder="Nom" value="<?php echo $_SESSION["name_register"] ?>">
                                    ...
                                    <div class="col-sm-6">
                                        <input type="text" name="lastnames_register"
                                               class="form-control form-control-user" placeholder="Cognoms"
                                               value="<?php echo $_SESSION["lastnames_register"] ?>">
                                ...
                                <div class="form-group">
                                    <input type="email" name="email_register" class="form-control form-control-user"
                                           placeholder="Email" value="<?php echo $_SESSION["email_register"] ?>">
                                    <?php if (isset($_SESSION["register_errors"]) && in_array("error_email_register", $_SESSION["register_errors"])): ?>
                                        <label class="ml-3 text-danger" style="font-size: 14px;"><i
                                                    class="fas fa-exclamation-circle mr-1"></i>Email invàlid o ja
                                            existent</label>
                                    <?php endif; ?>
                                </div>
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0">
                                        <input type="password" name="password_register"
                                               class="form-control form-control-user" placeholder="Contrasenya"
                                               value="<?php echo $_SESSION["password_register"] ?>">
                                        <?php if (isset($_SESSION["register_errors"]) && in_array("error_password_register", $_SESSION["register_errors"])): ?>
                                            <label class="ml-3 text-danger" style="font-size: 14px;"><i
                                                        class="fas fa-exclamation-circle mr-1"></i>La contrasenya ha de
                                                tenir 5 caràcters com a mínim</label>
                                        <?php endif; ?>
                                    </div>
                                    <div class="col-sm-6">
                                        <input type="password" name="password_confirm_register"
                                               class="form-control form-control-user"
                                               placeholder="Repeteix al contrasenya">
                                        <?php if (isset($_SESSION["register_errors"]) && in_array("error_password_confirm_register", $_SESSION["register_errors"])): ?>
                                            <label class="ml-3 text-danger" style="font-size: 14px;"><i
                                                        class="fas fa-exclamation-circle mr-1"></i>Les contrasenyes no
                                                concideixen</label>
                                        <?php endif; ?>
                                    </div>
                                </div>
                                ...
                                <?php if (isset($_SESSION["register_errors"]) && in_array("error_recaptcha_register", $_SESSION["register_errors"])): ?>
                                    <label class="ml-3 text-danger" style="font-size: 14px;"><i
                                                class="fas fa-exclamation-circle mr-1"></i>Fés clic el reCAPTCHA per
                                        continuar</label>
                                <?php endif; ?>
                                <button type="submit" href="login.html" class="btn btn-primary btn-user btn-block mt-3"
                                        style="background-color: #F6931D;border-color: #f5a342">
                                    Registrar el compte
                                </button>
                            </form>
                            <hr>
                        ...
                        <div class=" p-0 m-0">
                            <a href="../botiga_view/index.php" class="btn btn-dark btn-user btn-block"
                               style="color: white;background-color: #201F1E;border-radius: 0px;"><i
                                        class="fas fa-chevron-left"
                                        style="float: left;margin-top: 1%;margin-left: 10px"></i>Tornar a la botiga</a>
                        </div>
                    </div>
                </div>
            </div>
