...
$categories = $database->executeQuery("SELECT * FROM productCategory WHERE id IN (SELECT category_id FROM products) AND activated =? GROUP BY id ORDER BY id",array(1));
											...
											<ul class="nav main-menu menu navbar-nav">
													...
													<li><a href="#">Informació<i class="ti-angle-down"></i></a>
														<ul class="dropdown">
                                                            ...
                                                            <li><a href="blog-single-sidebar.php">Reviews dels clients</a></li>
